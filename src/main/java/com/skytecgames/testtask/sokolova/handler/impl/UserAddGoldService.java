package com.skytecgames.testtask.sokolova.handler.impl;

import com.skytecgames.testtask.sokolova.handler.CompleteTaskHandler;
...
public class UserAddGoldService implements CompleteTaskHandler { // пользователь добавляет золото из собственного кармана
